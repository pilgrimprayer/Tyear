...
public class EdiQAdapter extends RecyclerView.Adapter<EdiQAdapter.ViewHolder>  {

    private List<BaseQue> mList;  //用户列表


    public EdiQAdapter(List<BaseQue> list){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.add_question, parent, false);
