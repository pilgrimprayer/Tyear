...
import com.example.hxx.tyear.MineFragmentModel.MineItem;
...
public class MineAdapter extends RecyclerView.Adapter<MineAdapter.ViewHolder>  {
    ...
    private List<MineItem> mList;  //用户列表
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
      ...
      ;
        ...
        public MineItem mItem;
        public  ViewHolder(View view) {
            super(view);
            mView = view;
            content = (TextView) view.findViewById(R.id.mine_content);//加载每个子项里的内容-题目！！

           imageView=(ImageView) view.findViewById(R.id.mineImage);//加载每个子项里的内容-内容！！
